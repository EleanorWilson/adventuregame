...
/**
 * This scene is accessed through the {@code friendly} option of the
 * {@link SceneID#FOREST} scene.
 * <p>
 *     The mysterious figure from {@link SceneID#FOREST} scene is
 *     revealed as a wizard searching for an amulet to save the realm.
...
public class QuestScene implements Scene {
     ...
     * {@inheritDoc}
     * <p>
     *     Prints the quest offer scene. Decision prompt then loops until the
     *     player chooses a valid option:
     *     <ul>
    ...
    public SceneID play(Player player, GameIO io) {
        io.println();
        io.println("You greet the mysterious figure and introduce yourself, 'My name is " + player.getName() + ", can I help you?'");
        io.println();
        ...
        while (true) {
            ...
            } else if (choice.charAt(0) == '1' || choice.equals("accept") || choice.charAt(0) == 'a') {
                return SceneID.ACCEPT;
            } else if (choice.charAt(0) == '2' || choice.equals("refuse") || choice.charAt(0) == 'r') {
