...
public class FightScene implements Scene {
    ...
    public SceneID play(Player player, GameIO io) {
        io.println();
        io.println("You choose to fight and begin to rush a the figure. Before you are able to swing your sword, the crows dive towards you and begin their attack.");
        io.println();
