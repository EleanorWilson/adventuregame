 ...
 *     Whether to be {@code friendly} or to {@code threaten}. This
 *     choice determines the path for the rest of the story.
 * </p>
 * <p>
 *     This scene is also the target of the loop if the {@code flight}
 *     option is selected in the {@link SceneID#CROWS} scene.
 * </p>
 */
public class ForestScene implements Scene {
     ...
     *     Decision prompt then loops until the player choices a valid
     *     option:
     *     <ul>
    ...
    public SceneID play(Player player, GameIO io) {
        io.println();
        io.println("You find yourself walking through an enchanted forest. Ancient oaks covered in moss loom overhead. A thick fog clings to the undergrowth and an eerie hum of magic moves through the air.");
        io.println();
        io.println("Ahead, a mysterious figure in a dark cloak glides towards you through the mist, blocking your path.");
        io.println();
        io.println("How you do you approach the figure?");
